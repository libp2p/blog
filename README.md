...
This repository contains code and content for the [libp2p Blog & News](https://blog.libp2p.io/) website. To contribute to the site, please follow the instructions below for _post authors/editors_ and _site developers_.
...
- For card and blog post header images, **be sure to use the [image crop/scale tool](https://blog.libp2p.io/image-crop/)** to resize and save images so they're the correct dimensions. (Don't have an image? Don't worry, there are generic fallback images.)
